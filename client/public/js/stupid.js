...
var _jqueryMin = require('../bowerComponents/jquery/dist/jquery.min.js');
...
var LoginActions = function () {
  function LoginActions() {
    ...
    this.generateActions('loginSuccess', 'loginFail', 'noEmail', 'noPassword', 'getUserId');
  }
...
},{"../bowerComponents/jquery/dist/jquery.min.js":6,"../utils/alt":22}],2:[function(require,module,exports){
'use strict';
...
var MyPostsActions = function () {
  ...
  _createClass(MyPostsActions, [{
    ...
    value: function getMyPosts(id) {
      ...
      fetch('/api/myposts/' + id).then(function (response) {
        ...
        _this.actions.myPostsSuccess(results);
      }).catch(function (err) {
        _this.actions.myPostsFail(err);
      });
    }
  }, {
    key: 'deletePost',
    value: function deletePost(id) {
      ...
      _jqueryMin2.default.ajax({
        ...
        _this2.actions.deleteSuccess(id);
      }).fail(function (err) {
  ...
  return MyPostsActions;
}();

exports.default = _alt2.default.createActions(MyPostsActions);

},{"../bowerComponents/jquery/dist/jquery.min.js":6,"../utils/alt":22}],3:[function(require,module,exports){
'use strict';
...
},{"../bowerComponents/jquery/dist/jquery.min.js":6,"../utils/alt":22,"react-router":"react-router"}],4:[function(require,module,exports){
'use strict';
...
var SearchActions = function () {
  function SearchActions() {
    ...
    this.generateActions('searchSuccess', 'searchFail');
  }
  ...
  _createClass(SearchActions, [{
    key: 'getPost',
    value: function getPost(category) {
      var _this = this;

      console.log("category search actions", category);
      fetch('/api/search/' + category).then(function (response) {
        return response.json();
      }).then(function (results) {
        _this.actions.searchSuccess(results);
      }).catch(function (err) {
        _this.actions.searchFail(err);
      });
    }
  }]);
...
},{"../bowerComponents/jquery/dist/jquery.min.js":6,"../utils/alt":22}],5:[function(require,module,exports){
'use strict';
...
var SellActions = function () {
  function SellActions() {
    _classCallCheck(this, SellActions);

    this.generateActions('saleSuccess', 'saleFail', 'noEmail', 'noName');
  }

  // Sending new add information to DB


  _createClass(SellActions, [{
    key: 'createSell',
    value: function createSell(id, email, name, location, make, model, year, price, description, category, image) {
      var _this = this;
      ...
      _jqueryMin2.default.ajax({
        ...
        _this.actions.saleSuccess(data.message);
      }).fail(function (err) {
        _this.actions.saleFail(err);
      });
    }
  }]);
...
exports.default = _alt2.default.createActions(SellActions);

},{"../bowerComponents/jquery/dist/jquery.min.js":6,"../stores/LoginStore":17,"../utils/alt":22}],6:[function(require,module,exports){
"use strict";
...
},{"../bowerComponents/jquery/dist/jquery.min.js":6,"./Navbar":11,"react":"react"}],8:[function(require,module,exports){
'use strict';
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'p',
                    { className: 'dirty' },
                    'And other things that get dirty.'
                )
            )
        );
    }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h2',
            { className: 'form-signin-heading header' },
            'ACCOUNT LOGIN'
          ),
          _react2.default.createElement(
            'label',
          ...
          _react2.default.createElement('input', { type: 'email', id: 'inputEmail', ref: 'email', className: 'form-control', placeholder: 'Email address', required: true, autofocus: true, value: this.state.email, onChange: this.handleEmailChange }),
          _react2.default.createElement(
            'label',
            { className: 'sr-only' },
            'Password'
          ),
          _react2.default.createElement('input', { type: 'password', id: 'inputPassword', ref: 'password', className: 'form-control', placeholder: 'Password', required: true, value: this.state.password, onChange: this.handlePasswordChange }),
          _react2.default.createElement(
            'div',
...
var _MyPostsActions = require('../actions/MyPostsActions');

var _MyPostsActions2 = _interopRequireDefault(_MyPostsActions);

var _MyPostsStore = require('../stores/MyPostsStore');

var _MyPostsStore2 = _interopRequireDefault(_MyPostsStore);
...
var MyPosts = function (_React$Component) {
    _inherits(MyPosts, _React$Component);

    function MyPosts(props) {
        _classCallCheck(this, MyPosts);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MyPosts).call(this, props));

        _this.state = _MyPostsStore2.default.getState();
    ...
    _createClass(MyPosts, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            _MyPostsStore2.default.listen(this.onChange);
        }
        ...
        key: 'componentWillUnmount',
        value: function componentWillUnmount() {
            _MyPostsStore2.default.unlisten(this.onChange);
        }
        ...
        value: function render() {
            ...
            if (this.state.searchState) {
                return _react2.default.createElement(
                    'div',
                    null,
                    this.state.searchResults.map(function (post) {
                        console.log("results", post);
                        return _react2.default.createElement(
                            'div',
                            { className: 'item', key: post.postId },
                            _react2.default.createElement(
                                'span',
                            ...
                            _react2.default.createElement(
                                'button',
                                { className: 'btn btn-danger delete', value: post.postId, onClick: _this2.handleDeletePost },
                                'Delete Post'
                            )
                        );
                    })
...
},{"../actions/MyPostsActions":2,"../components/Navbar":11,"../stores/MyPostsStore":18,"../utils/alt":22,"react":"react"}],11:[function(require,module,exports){
'use strict';
...
var Navbar = function (_React$Component) {
    ...
    function Navbar(props) {
        ...
        _this.handleMyPosts = _this.handleMyPosts.bind(_this);
        return _this;
    }
    ...
    _createClass(Navbar, [{
        ...
        key: 'handleMyPosts',
        value: function handleMyPosts() {
            var login = _LoginStore2.default.getState();
            var id = login.userId;
            _MyPostsActions2.default.getMyPosts(id);
        }
    }, {
        key: 'handleLogout',
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'ul',
                                { className: 'nav navbar-nav options' },
                                _react2.default.createElement(
                                    'li',
                                    null,
                                    _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        _reactRouter.Link,
                                        { to: '/myposts', onClick: this.handleMyPosts },
                                        'My Posts'
                                    )
                                ),
                                _react2.default.createElement(
...
var Register = function (_React$Component) {
  ...
  _createClass(Register, [{
    ...
    value: function handleConfirmPasswordChange() {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'password', id: 'inputPassword', ref: 'password', className: 'form-control', placeholder: 'Password', required: true, value: this.state.password, onChange: this.handlePasswordChange }),
          _react2.default.createElement('input', { type: 'password', id: 'inputPassword', ref: 'confirmPassword', className: 'form-control', placeholder: 'Confirm Password', required: true, value: this.state.confirmPassword, onChange: this.handleConfirmPasswordChange }),
          _react2.default.createElement(
            'button',
            { className: 'btn btn-lg btn-primary btn-block', onClick: this.handleSubmit, type: 'submit' },
            'Register'
...
},{"../actions/RegisterActions":3,"../stores/RegisterStore":19,"react":"react","react-router":"react-router"}],13:[function(require,module,exports){
'use strict';
...
var Search = function (_React$Component) {
    ...
    function Search(props) {
        ...
        _this.handleNewSearchSubmit = _this.handleNewSearchSubmit.bind(_this);
    ...
    _createClass(Search, [{
        ...
        key: 'handleNewSearchSubmit',
        value: function handleNewSearchSubmit() {
            _alt2.default.recycle(_SearchStore2.default);
        }
        ...
        value: function handleSearchSubmit() {
            var category = this.refs.menu.value;
            _SearchActions2.default.getPost(category);
        }
    }, {
        key: 'render',
        value: function render() {
            if (this.state.searchState) {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'newSearch btn btn-default', onClick: this.handleNewSearchSubmit },
                        'New Search'
                    )
                );
            } else {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'label',
                            { className: 'control-label category-search' },
                            'Choose Category'
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'select',
                                { className: 'form-control inputs2', id: 'expertise', ref: 'menu', onChange: this.handleCategoryChange },
                                _react2.default.createElement(
                                    'option',
                                    { ref: 'atv', value: 'ATV' },
                                    'ATV'
                                ...
                                _react2.default.createElement(
                                    'option',
                                    { ref: 'jeep', value: 'Truck' },
                                    'Truck'
                                ),
                                _react2.default.createElement(
                                    'option',
                                    { ref: 'other', value: 'Other' },
                                    'Other'
                                )
                            )
                        )
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-default post-btn search-btn', onClick: this.handleSearchSubmit },
                        'Search'
                    )
                );
            }
...
},{"../actions/SearchActions":4,"../stores/SearchStore":20,"../utils/alt":22,"react":"react"}],14:[function(require,module,exports){
'use strict';
...
var _SellActions = require('../actions/SellActions');

var _SellActions2 = _interopRequireDefault(_SellActions);

var _SellStore = require('../stores/SellStore');

var _SellStore2 = _interopRequireDefault(_SellStore);
...
var Sell = function (_React$Component) {
  ...
  function Sell(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Sell).call(this, props));

    _this.state = _SellStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    _this.handleEmailChange = _this.handleEmailChange.bind(_this);
  ...
  _createClass(Sell, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _SellStore2.default.listen(this.onChange);
    }
    ...
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _SellStore2.default.unlisten(this.onChange);
    }
    ...
    value: function handleMakeChange() {
    ...
    value: function handleSubmit(event) {
      event.preventDefault();
      var loginState = _LoginStore2.default.getState();
      ...
      if (email && name) {
        _SellActions2.default.createSell(userId, email, name, location, make, model, year, price, description, category, image);
      }
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: '' },
            _react2.default.createElement('input', { type: 'email', className: 'form-control', ref: 'email', value: this.state.email, onChange: this.handleEmailChange, placeholder: 'Email' })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: '' },
            _react2.default.createElement('input', { type: 'input', className: 'form-control', ref: 'name', value: this.state.name, onChange: this.handleNameChange, placeholder: 'Name' })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: '' },
            _react2.default.createElement('input', { type: 'input', className: 'form-control', ref: 'location', value: this.state.location, onChange: this.handleLocationChange, placeholder: 'Location' })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: '' },
            _react2.default.createElement('input', { type: 'input', className: 'form-control', ref: 'make', value: this.state.make, onChange: this.handleMakeChange, placeholder: 'Make' })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: '' },
            _react2.default.createElement('input', { type: 'input', className: 'form-control', ref: 'model', value: this.state.model, onChange: this.handleModelChange, placeholder: 'Model' })
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'form-group-year' },
          _react2.default.createElement(
            'label',
            { className: 'control-label' },
            'Year'
          ...
          _react2.default.createElement(
            'div',
            { className: '' },
            _react2.default.createElement('input', { type: 'input', className: 'form-control', ref: 'year', value: this.state.year, onChange: this.handleYearChange, placeholder: 'Year' })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: '' },
            _react2.default.createElement('input', { type: 'input', className: 'form-control', ref: 'price', value: this.state.price, onChange: this.handlePriceChange, placeholder: 'Price $' })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement('textarea', { className: 'form-control', rows: '3', ref: 'description', value: this.state.description, onChange: this.handleDescriptionChange, placeholder: 'Vehicle description' })
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'label',
            { className: 'control-label category' },
            'Category'
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              'select',
              { className: 'form-control inputstl', id: 'expertise', ref: 'menu', onChange: this.handleCategoryChange },
              _react2.default.createElement(
                'option',
                { ref: 'atv', value: 'ATV' },
                'ATV'
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'btn btn-default post-btn button-add', onClick: this.handleSubmit },
              'Post Add'
            )
          )
        )
...
},{"../actions/SellActions":5,"../stores/LoginStore":17,"../stores/SellStore":21,"react":"react","react-dropzone":42,"react-router":"react-router"}],15:[function(require,module,exports){
'use strict';
...
var _Sell = require('../components/Sell');

var _Sell2 = _interopRequireDefault(_Sell);

var _MyPosts = require('../components/MyPosts');
...
exports.default = _react2.default.createElement(
    ...
    _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouter.Route, { path: '/sale', component: _Sell2.default }),
        _react2.default.createElement(_reactRouter.Route, { path: '/myposts', component: _MyPosts2.default })
    )
);

},{"../components/App":7,"../components/Home":8,"../components/Login":9,"../components/MyPosts":10,"../components/Register":12,"../components/Search":13,"../components/Sell":14,"react":"react","react-router":"react-router"}],16:[function(require,module,exports){
'use strict';
...
},{"./config/routes":15,"history/lib/createBrowserHistory":32,"react":"react","react-dom":"react-dom","react-router":"react-router"}],17:[function(require,module,exports){
'use strict';
...
},{"../actions/LoginActions":1,"../utils/alt":22}],18:[function(require,module,exports){
'use strict';
...
var MyPostsStore = function () {
  function MyPostsStore() {
    _classCallCheck(this, MyPostsStore);

    this.bindActions(_MyPostsActions2.default);
  ...
  _createClass(MyPostsStore, [{
    key: 'onMyPostsSuccess',
    value: function onMyPostsSuccess(results) {
    ...
    key: 'onMyPostsFail',
    value: function onMyPostsFail(err) {
    ...
    key: 'onDeleteSuccess',
    value: function onDeleteSuccess(id) {
      var newId = parseInt(id);
      this.searchResults = this.searchResults.filter(function (r) {
...
exports.default = _alt2.default.createStore(MyPostsStore);

},{"../actions/MyPostsActions":2,"../utils/alt":22}],19:[function(require,module,exports){
'use strict';
...
},{"../actions/RegisterActions":3,"../utils/alt":22}],20:[function(require,module,exports){
'use strict';
...
var SearchStore = function () {
  ...
  _createClass(SearchStore, [{
    ...
    key: 'onSearchFail',
    value: function onSearchFail(err) {
...
},{"../actions/SearchActions":4,"../utils/alt":22}],21:[function(require,module,exports){
'use strict';
...
var SellStore = function () {
  function SellStore() {
    _classCallCheck(this, SellStore);

    this.bindActions(_SellActions2.default);
    this.email = '';
    this.name = '';
    this.helpBlock = '';
    this.emailValidationState = '';
  ...
  _createClass(SellStore, [{
    key: 'onSaleSuccess',
    value: function onSaleSuccess(successMessage) {
    ...
    key: 'onSaleFail',
    value: function onSaleFail(errorMessage) {
      this.emailValidationState = 'has-error';
      this.helpBlock = errorMessage;
...
exports.default = _alt2.default.createStore(SellStore);

},{"../actions/SellActions":5,"../utils/alt":22}],22:[function(require,module,exports){
'use strict';
...
},{"_process":41,"warning":43}],30:[function(require,module,exports){
'use strict';
...
},{"./extractPath":37,"_process":41,"warning":43}],39:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":41,"warning":43}],40:[function(require,module,exports){
(function (process){
/**
...
module.exports = exports['default'];
},{"attr-accept":23,"react":"react"}],43:[function(require,module,exports){
(function (process){
/**
